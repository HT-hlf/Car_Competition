...
for i in range(40,60):
    ...
    #亮度
    # c_10=cap.set(cv2.CAP_PROP_BRIGHTNESS,32)
    # #对比度
    #c_11=cap.set(cv2.CAP_PROP_CONTRAST,32)
    # #饱和度
    # c_12=cap.set(cv2.CAP_PROP_SATURATION,32)
    # cap.set(cv2.CAP_PROP_SHARPNESS,255)
    # #色相
    cap.set(cv2.CAP_PROP_HUE,i*0.01)
    # #增益
    # c_14=cap.get(cv2.CAP_PROP_GAIN)
    # #曝光
    ...
    cv2.imwrite('HUE/HUE:{}.png'.format(c_13), frame)
