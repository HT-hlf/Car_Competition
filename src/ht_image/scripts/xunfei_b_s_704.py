...
def detect():
    ...
    while(not end_sign):
        ...
        if img_num>old_img_num:
            ...
            time.sleep((img_num-old_img_num)*0.5)
                ...
                if det is not None and len(det):
                    ...
                    for *xyxy, conf, cls in det:
                        ...
                        if torch.as_tensor(cls).tolist() == 0.0:
                            ...
                            # print('None')
                    # .......................ls..................................
                    true_people_distance_x = 352
                    true_people_distance_y = 352
                    true_ht_cls = -1
                    ...
                    if len(ht_people_may)!=0:
                        for people in ht_people_may:
                            # print('1')
                            # print(people[0])
                            if (abs(people[0] - 352) < true_people_distance_x and abs(
                                    people[1] - 352) < true_people_distance_y):
                                true_people_distance_x = abs(people[0] - 352)
                                true_people_distance_y = abs(people[1] - 352)
