...
class Navigate(smach.State):
    ...
    def get_waypoints(self,num):
        waypoints = [
            ...
            [[2.328, -2.75, 0.000],[0.000, 0.000, 0.976, 0.219]],
            ...
            [[0.975, -1.109, 0.000],[0.000, 0.000, 0.732, 0.681]],  
            [[0.475, -1.109, 0.000],[0.000, 0.000, 0.749, 0.663]],         
            [[-0.025, -1.109, 0.000],[0.000, 0.000, 0.680, 0.733]]
