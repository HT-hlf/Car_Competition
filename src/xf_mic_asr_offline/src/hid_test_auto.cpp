...
void funclose(const std_msgs::String::ConstPtr& msg)
{
...
sub_close = ndHandle.subscribe("/close",10,funclose);
/*离线命令词识别*/
    /*get_offline_recognise_result_client = 
    ndHandle.serviceClient<xf_mic_asr_offline::Get_Offline_Result_srv>("xf_asr_offline_node/get_offline_recognise_result_srv");
...
sta = ndHandle.advertise<std_msgs::String>("/startfl",10);
