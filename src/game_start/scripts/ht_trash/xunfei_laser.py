...
def listener():
    ...
    for list in sum_people_list:
        ...
        if list_num1 > list_num1_th:
            ...
            if (map_people_th_x<x_last1<150-map_people_th_x and 100+map_people_th_y1<y_last1 <250-map_people_th_y) or (map_people_th_x<x_last<150-map_people_th_x and 100+map_people_th_y1<y_last <250-map_people_th_y):
                if not map_people_th_x < x_last1 < 150 - map_people_th_x and 100 + map_people_th_y1 < y_last1 < 250 - map_people_th_y:
                    x_person = x_last
                    y_person = y_last
                elif not map_people_th_x < x_last < 150 - map_people_th_x and 100 + map_people_th_y1 < y_last < 250 - map_people_th_y:
                    x_person = x_last1
                    y_person = y_last1
                else:
