...
# c_10=cap.set(cv2.CAP_PROP_BRIGHTNESS,0.2)
# cap.set(cv2.CAP_PROP_SATURATION,0.1)
# cap.set(cv2.CAP_PROP_AUTO_EXPOSURE, 0.25)
# cap.set(cv2.CAP_PROP_HUE,0.9)
# # c_15 = cap.set(cv2.CAP_PROP_EXPOSURE, 0.48)
...
#cap.set(cv2.CAP_PROP_AUTO_EXPOSURE, 0.25)
#c_15 = cap.set(cv2.CAP_PROP_EXPOSURE, 0.04)
...
while(True):
    ...
    cv2.rectangle(frame, (974, 494), (1326, 846), (0, 255, 0), 2)
