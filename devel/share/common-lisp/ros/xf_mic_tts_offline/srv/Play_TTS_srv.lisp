...
(cl:in-package xf_mic_tts_offline-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Play_TTS_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Play_TTS_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_tts_offline-srv:<Play_TTS_srv-request> is deprecated: use xf_mic_tts_offline-srv:Play_TTS_srv-request instead.")))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <Play_TTS_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_tts_offline-srv:text-val is deprecated.  Use xf_mic_tts_offline-srv:text instead.")
  (text m))

(cl:ensure-generic-function 'speakerName-val :lambda-list '(m))
(cl:defmethod speakerName-val ((m <Play_TTS_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_tts_offline-srv:speakerName-val is deprecated.  Use xf_mic_tts_offline-srv:speakerName instead.")
  (speakerName m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Play_TTS_srv-request>)))
  ...
  "xf_mic_tts_offline/Play_TTS_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Play_TTS_srv-request)))
  "Returns string type for a service object of type 'Play_TTS_srv-request"
  "xf_mic_tts_offline/Play_TTS_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Play_TTS_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Play_TTS_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_tts_offline-srv:<Play_TTS_srv-response> is deprecated: use xf_mic_tts_offline-srv:Play_TTS_srv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Play_TTS_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_tts_offline-srv:result-val is deprecated.  Use xf_mic_tts_offline-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'fail_reason-val :lambda-list '(m))
(cl:defmethod fail_reason-val ((m <Play_TTS_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_tts_offline-srv:fail_reason-val is deprecated.  Use xf_mic_tts_offline-srv:fail_reason instead.")
  (fail_reason m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Play_TTS_srv-response>)))
  ...
  "xf_mic_tts_offline/Play_TTS_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Play_TTS_srv-response)))
  "Returns string type for a service object of type 'Play_TTS_srv-response"
  "xf_mic_tts_offline/Play_TTS_srvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Play_TTS_srv)))
  ...
  "xf_mic_tts_offline/Play_TTS_srv")