...
def ht_save_image_a(self):
    ...
    cv2.imwrite('/home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei_detect_img/x_a.jpg'.format(i), frame)
...
class Navigate27(smach.State):
    ...
    def get_waypoints(self):
        waypoints = [
            [[1.499, -2.046, 0.000],[0.000, 0.000, -0.713, 0.701]]   #7号区域
...
class voiceSuccess(smach.State):
    ...
    def execute(self, userdata):
        ...
        # data = '本次送餐人物途中遇到2个人，其中长头发：'+str(longhair)+'人。'+'戴眼镜：'+str(glasses)+'人。'
        # data = str(data) 
...
def main():
    ...
    with sm:        
        smach.StateMachine.add('WAIT', Wait4Awake(),transitions={'navigating':'NAV27', 'wait':'WAIT' })
