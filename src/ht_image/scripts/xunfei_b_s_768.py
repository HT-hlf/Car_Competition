                ...
                if det is not None and len(det):
                    ...
                    for *xyxy, conf, cls in det:
                        ...
                        if torch.as_tensor(cls).tolist() == 0.0:
                            ...
                            # print('None')
                    # .......................ls..................................
                    true_people_distance_x = 384
                    true_people_distance_y = 384
                    true_ht_cls = -1
                    ...
                    if len(ht_people_may)!=0:
                        for people in ht_people_may:
                            # print('1')
                            # print(people[0])
                            if (abs(people[0] - 384) < true_people_distance_x and abs(
                                    people[1] - 384) < true_people_distance_y):
                                true_people_distance_x = abs(people[0] - 384)
                                true_people_distance_y = abs(people[1] - 384)
