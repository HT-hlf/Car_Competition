...
(cl:in-package game_start_msg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Play_TTS_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Play_TTS_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name game_start_msg-srv:<Play_TTS_srv-request> is deprecated: use game_start_msg-srv:Play_TTS_srv-request instead.")))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <Play_TTS_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader game_start_msg-srv:text-val is deprecated.  Use game_start_msg-srv:text instead.")
  (text m))

(cl:ensure-generic-function 'speakerName-val :lambda-list '(m))
(cl:defmethod speakerName-val ((m <Play_TTS_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader game_start_msg-srv:speakerName-val is deprecated.  Use game_start_msg-srv:speakerName instead.")
  (speakerName m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Play_TTS_srv-request>)))
  ...
  "game_start_msg/Play_TTS_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Play_TTS_srv-request)))
  "Returns string type for a service object of type 'Play_TTS_srv-request"
  "game_start_msg/Play_TTS_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Play_TTS_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Play_TTS_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name game_start_msg-srv:<Play_TTS_srv-response> is deprecated: use game_start_msg-srv:Play_TTS_srv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Play_TTS_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader game_start_msg-srv:result-val is deprecated.  Use game_start_msg-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'fail_reason-val :lambda-list '(m))
(cl:defmethod fail_reason-val ((m <Play_TTS_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader game_start_msg-srv:fail_reason-val is deprecated.  Use game_start_msg-srv:fail_reason instead.")
  (fail_reason m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Play_TTS_srv-response>)))
  ...
  "game_start_msg/Play_TTS_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Play_TTS_srv-response)))
  "Returns string type for a service object of type 'Play_TTS_srv-response"
  "game_start_msg/Play_TTS_srvResponse")
