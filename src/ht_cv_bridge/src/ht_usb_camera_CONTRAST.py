...
for i in range(0,11):
    ...
    # #对比度
    c_11=cap.set(cv2.CAP_PROP_CONTRAST,i*0.1)
    # #饱和度
    c_12=cap.set(cv2.CAP_PROP_SATURATION,0.1)
    ...
    c_15=cap.set(cv2.CAP_PROP_EXPOSURE,0.3)
    # c_15=cap.get(cv2.CAP_PROP_EXPOSURE)
    ...
    cv2.imwrite('CONTRAST/CONTRAST:{}_1920.png'.format(c_11), frame)
