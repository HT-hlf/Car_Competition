...
def detect():
    ...
    #cp /home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei_control/a_end.jpg /home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei_detect_img/
    end_sign_shoudong=False
    while (not end_sign_shoudong):
        img_dect_list = os.listdir(img_dect)
        img_num = len(img_dect_list)
        for file in img_dect_list:
            if file=='a_end.jpg':
                end_sign_shoudong = True
                break
        # publish_count = True
        # for file in img_dect_list:
        #     if file=='a_ht.jpg':
