...
def thread_detect_cam():
    os.system('python3 /home/ucar/ROS_xunfei/ucar_ws/src/ht_detect_control/xunfei_x_save_img.py')
    ...
    def execute(self, userdata):
        if rospy.is_shutdown():
            ...
            for pose in waypoints:                   
                ...
                self.client.send_goal(goal)
                self.client.wait_for_result()
                add_thread = threading.Thread(target = thread_detect_cam)
                add_thread.start()
                rospy.sleep(1.5)
            return 'arrived'
...
def thread_detect_pub():
    ...
    shutil.copy('/home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei_control/a_start_detect.jpg', '/home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei_detect_img/a_start_detect.jpg')
...
class voiceSuccess(smach.State):
    ...
    def execute(self, userdata):
        ...
        shutil.copy('/home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei_control/a_end_detect.jpg', '/home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei_detect_img/a_end_detect.jpg')
...
def thread_detect():
    os.system('python3 /home/ucar/ROS_xunfei/ucar_ws/src/ht_image/scripts/xunfei6.0.py')
